...
import me.novoro.TutorMoves.config.ConfigVersionUpdater;
import me.novoro.TutorMoves.config.Configuration;
import me.novoro.TutorMoves.config.YamlConfiguration;
...
import me.novoro.TutorMoves.util.PermissionHelper;
...
public class TutorMoves implements ModInitializer {
    ...
    private void setupPermissions() {
        try {
            ...
            TutorMovesLogger.info("Permissions system initialized!");
        } catch (Exception e) {
            TutorMovesLogger.error("Failed to initialize permissions system!");
    ...
    private void checkLuckPermsDependency() {
        ...
        if (isLuckPermsAvailable) {
            TutorMovesLogger.info("LuckPerms API is available, enabling LuckPerms-specific features.");
        } else {
            TutorMovesLogger.warn("LuckPerms API is not available, disabling LuckPerms-specific features.");
        }
    }
