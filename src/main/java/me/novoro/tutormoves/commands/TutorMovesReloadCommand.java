...
public final class TutorMovesReloadCommand extends CommandBase {
    public TutorMovesReloadCommand() {
        super("tutormoves", "tutormoves.base", 4);
    }
    ...
    public LiteralArgumentBuilder<ServerCommandSource> getCommand(LiteralArgumentBuilder<ServerCommandSource> command) {
        return command.then(literal("reload")
                .requires(source -> this.permission(source, "tutormoves.reload", 2))
                .executes(context -> {
                ...
                .then(argument("tutor_name", StringArgumentType.string())
                        ...
                        .executes(context -> {
                            ...
                            if (enabled)
                                LangManager.sendLang(context.getSource(), "NPC-Mode-Enabled");
                            else
                                LangManager.sendLang(context.getSource(), "NPC-Mode-Disabled");
