...
/**
 * TutorMoves' color utilities, mostly powered by {@link MiniMessage}.
 */
public final class ColorUtil {
    ...
    public static String toJson(Text text) {
        return Text.Serialization.toJsonString(text, TutorMoves.getServer().getRegistryManager());
    }

    public static Text fromJson(String json) {
        return Text.Serialization.fromJson(json, TutorMoves.getServer().getRegistryManager());
    }
    ...
    static String getLegacyReplacement(String input) {
