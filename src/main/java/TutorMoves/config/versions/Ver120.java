package TutorMoves.config.versions;
...
public class Ver120 {
    ...
    public void update(Configuration config, String fileName) {
        ...
        if (fileName.equals("config.yml")) {
            updateOrCreateSection(config, "TutorMoves.GUI.title", "<red><bold>General Tutor");
            updateOrCreateSection(config, "TutorMoves.GUI.size", 6);
            updateOrCreateSection(config, "TutorMoves.GUI.filler-item", "minecraft:gray_stained_glass_pane");
        }
